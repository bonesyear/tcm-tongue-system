...
**用户肉眼裁定（最终权威）：点刺无** → **Qwen 判对，native 过度判读**（与豆包／K3 的历史问题同类）。

> **结论：维持 Qwen 为识图主力。** native 虽快约 2.7–3 倍，但在点刺项过度判读；速度收益不足以抵消判读保守性的损失。若未来要重新评估，须以**用户肉眼**为裁定基准，并同时观察多项体征而非仅看速度。
