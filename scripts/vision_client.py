...
PROMPTS = {
    "舌面": "这是一张舌面照片，请精确观察并只输出JSON：舌质颜色、舌苔(颜色/厚薄/润燥/腻腐/剥落)、舌体(胖瘦/齿痕/裂纹/点刺)、舌质润燥(键名固定为\"舌质润燥\"，值只填一个词：润泽/偏干/干燥/干裂)。舌体胖瘦只填规范词：正常/适中、偏胖、胖大、偏瘦、瘦小（必要时可填肿胀）；若观察到复合描述（如\"胖嫩\"\"瘦薄\"），只按胖瘦成分填写（胖嫩→偏胖，瘦薄→偏瘦），老嫩/厚薄成分不进该字段。齿痕只填规范词：无/轻度/中度/重度（不填\"明显齿痕\"\"舌缘可见\"等描述性短语）。注意区分舌面中央的浅沟是生理性正中沟还是深宽病理裂纹。不判舌神/荣枯（照片光线干扰、静态不可判）。",
